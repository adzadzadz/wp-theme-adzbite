...
<header class="col-lg-12 col-sm-12 col-xs-12">
	...
	<nav class="mini">
			...
			<div class="left-nav wide-screen-menu col-lg-5 col-md-5 col-sm-6">

				<?php wp_nav_menu( array('theme_location' => 'top_menu_left', 'items_wrap' => '<ul id="%1$s" class="%2$s float-li-left">%3$s</ul>', )); ?>

			</div>
			<div class="social_icons_wrap col-lg-3 col-md-3 wide-screen-menu">
			...
			<div class="right-nav col-lg-2 col-md-2 col-sm-3 wide-screen-menu">
